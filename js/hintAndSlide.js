...
// ==============================
// SOLO PRIMA SOLUZIONE AGGIUNTA:
// Fullscreen + orientamento landscape
// ==============================
async function toggleFullscreen(n) {
    ...
    try {
        if (!document.fullscreenElement) {
            ...
            // prova a bloccare in landscape (richiede gesto utente e può fallire)
            ...
            // sblocca orientamento se possibile
...
// Se l'utente esce con ESC o gesto di sistema, prova a sbloccare orientamento
